...
namespace KinematicCharacterController
{
	public interface ICharacterController
	{
		...
		/// <summary>
		///     This is called after when the motor wants to know if the collider can be collided with (or if we just go through
		///     it)
		/// </summary>
		...
		/// <summary>
		///     This is called when the character detects discrete collisions (collisions that don't result from the motor's
		///     capsuleCasts when moving)
		/// </summary>
